 ...
 *
 * The same compiler also serves `over`/`args`/`set` VALUE expressions (not just boolean guards), which
 * additionally permit arithmetic (`+ - * / %`) and `[array, literals]` — see OPS and the token grammar below.
 *
