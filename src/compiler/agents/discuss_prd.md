...
**`reharness/.cache/scratch/prd.md`** — the human-readable specification of the workflow. It is the source of intent for everything the compiler builds next.
...
1. Read `reharness/.cache/scratch/prd.md` to load what the user just saw.
