...
- `reharness/skills/*.md` if present — the domain-skills the research stage produced; fold in domain facts and genuinely-fitting best practices (intent only — leave exact endpoints/auth to the implementers); cite nothing speculative.
